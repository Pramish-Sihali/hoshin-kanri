        ...
        <CardContent className="space-y-6">
          ...
          <Button
            ...
            onClick={() => {
              ...
              setEmail('admin@hoshin.com');
              setPassword('admin123');
              // We need to trigger the sign in directly
              signIn('credentials', {
            ...
            className="w-full h-12 bg-slate-800 hover:bg-slate-900 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
          >
